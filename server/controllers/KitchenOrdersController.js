  ...
  SELECT
    ...
    ROUND(SUM(
      CASE
        ...
        WHEN COALESCE(scanned_totals.scanned_total, item_scanned_totals.scanned_total) > 0 THEN COALESCE(scanned_totals.scanned_total, item_scanned_totals.scanned_total)
