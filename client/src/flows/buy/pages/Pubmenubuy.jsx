...
function Toast({ message, type = "success", onClose }) {
  ...
  return (
    <div
      className={`fixed bottom-4 left-4 right-4 md:left-auto md:right-4 z-50 rounded-lg shadow-lg p-4 ${type === "error" ? "bg-red-600" : "bg-green-600"
...
function ActionButton({ children, className = "", ...props }) {
  return (
    <button
      type="button"
      className={`inline-flex items-center justify-center gap-2 rounded-full px-3 py-2 md:px-5 md:py-2.5 text-sm font-semibold text-white shadow-sm transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-afmc-gold/60 focus-visible:ring-offset-2 focus-visible:ring-offset-afmc-maroon active:scale-[0.99] ${className}`}
      {...props}
    >
      {children}
    </button>
    ...
    <div className="min-h-screen bg-stone-50 px-3 py-4 md:px-6">
      ...
      <div className="mx-auto max-w-[1180px] space-y-4">
        ...
        <div className="overflow-hidden rounded-2xl border border-afmc-gold/20 bg-white shadow-[0_6px_18px_rgba(15,23,42,0.06)]">
          ...
          {/* Summary */}
          <div className="grid grid-cols-2 gap-3 border-t border-stone-200 bg-white p-4 md:grid-cols-3">
            ...
            <div className="col-span-2 md:col-span-1 rounded-xl border border-afmc-gold/20 bg-gradient-to-br from-white to-afmc-gold/5 p-3">
