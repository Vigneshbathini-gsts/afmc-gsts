        ...
        <table className="min-w-full">
          ...
          <thead className="bg-afmc-maroon text-white">
            ...
            <tr>
              ...
              <th className="whitespace-nowrap p-3 text-center">Day</th>

              <th className="whitespace-nowrap p-3 text-center">Shift 1 From</th>

              <th className="whitespace-nowrap p-3 text-center">Shift 1 To</th>

              <th className="whitespace-nowrap p-3 text-center">Shift 2 From</th>

              <th className="whitespace-nowrap p-3 text-center">Shift 2 To</th>

              <th className="whitespace-nowrap p-3 text-center">Active</th>
                ...
                {[
                  ...
                  <td key={field} className="p-2 text-center align-middle">
                    <input
                      ...
                      className="mx-auto block w-full rounded-md border px-2 py-2 text-center"
                    />
                  </td>
                ))}
