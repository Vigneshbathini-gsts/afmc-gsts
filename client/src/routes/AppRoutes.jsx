    ...
    <BarStatusGuard>
      <Routes>
        ...
        >
          ...
          <Route
            path="stock-reports"
            element={<Navigate to="barstock" replace />}
          />
          ...
          <Route
            path="today-stock-out-details"
            element={<TodayStockOutDetails />}
          />
        ...
        >
          ...
          <Route
            path="Buyflowinvoicereport"
            element={<AttendantBuyflowinvoicereport />}
          />
        ...
        <Route
          ...
          element={
            <ProtectedRoute
              allowedRoles={[20, 30]}
              roleLoginTypeRules={{ 30: ["Non Member"] }}
            >
              <UserLayout />
            </ProtectedRoute>
          }
        >
          ...
          <Route
            path="Buyflowinvoicereport"
            element={<UserBuyflowinvoicereport />}
          />
          <Route path="invoice-report" element={<UserInvoiceReport />} />
